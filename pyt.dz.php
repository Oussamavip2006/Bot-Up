<html>
   <head> <title>InstaUp-@PYT-DZ</title>
...
<br>   
<center><p>-=-••𝗣𝗬𝗧••-=-<span></span></p></center>
<br>
<center><p>-=𝗣𝗬𝗧-𝗗𝗭=-<span></span></p></center>
<br>
";
...
<font color='red'><hr>$cc<hr></font></center></div>";
	...
	<section>
		<div class="container p-5 ">
			<form action="" method="get">
				<div class="mb-3">
					<label class="form-label">ɪᴅ-ᴛᴀʀɢᴇᴛ </label>
					<input type='text' name='target' class="form-control" required>
					<div  class="form-text">ايـدي فيـه نقـاط</div>
					
				</div>
				<div class="mb-3">
					<label class="form-label">ᴜsᴇʀ-ɪᴅ</label>
					<input type='text' name='userid' class="form-control" required>
					<div  class="form-text">ايـدي الخـاص بحسابــك الانستـا</div>
	...
	<section>
		<div class="container p-2 text-center">
			...
			<button onclick="location.href='https://www.instagram.com/llbv_'" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-instagram"></i></button>
			<button onclick="location.href='https://www.facebook.com/profile.php?id=100065381023182'" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-facebook-square"></i></button>
			<p class="text-muted p-5">©PYT-YASSINE </p>
